...
//         try {
//           const response = await axios.get(`http://localhost:5000${statusUrl}`);
//           if (response.status === 200 && response.data.result && Array.isArray(response.data.result) && response.data.result.length === 4) {
//             const results = {
//               prediction: response.data.result[0],
//               confidence: response.data.result[1],
//               errorType: response.data.result[2],
//               analysisScore: response.data.result[3]
//             };
  ...
  useEffect(() => {
    ...
    if (fileId && statusUrl) {
      interval = setInterval(async () => {
        try {
          const response = await axios.get(`http://localhost:5000${statusUrl}`);
          if (response.status === 200 && response.data.result && response.data.result.prediction && response.data.result.confidence && response.data.result.probabilities) {
